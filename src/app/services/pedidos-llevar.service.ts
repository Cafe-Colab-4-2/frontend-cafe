...
import { CostosTotalesMesas, Pedido } from '../models/pedidos.model';
...
export class PedidosLlevarSerivce {
  ...
  constructor( 
    ...
    verificaMesas() {
    const existe = localStorage.getItem('pedidos');
    // console.log(existe);
    ...
    guardarMesas() {
    localStorage.setItem('pedidos',  JSON.stringify(this.mesas));
    }
